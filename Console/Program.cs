...
eg. 'Transform-position-Vector3:Transform-rotation-Quaternion'";
    ...
    class Program
    {
        ...
        {
            return Parser.Default.ParseArguments<AddEventsOptions, RevertToOriginalOptions, ListExistingAutoGeneratedEventsOptions>(args)
                .MapResult(
        ...
        private static List<TypeWithAutoGeneratedEvents> GetExistingTypesWithAutoGeneratedEvents(string targetDllPath)
        {
